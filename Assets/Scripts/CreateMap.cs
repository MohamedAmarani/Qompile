...
public class CreateMap : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = -20; i < 150; ++i)
            for (int j = 0; j < 50; ++j)
            {
                GameObject obj = (GameObject)Instantiate(groundCube, new Vector3(i * 5.0f, 8.0f, -200 + j * 8.7f), Quaternion.Euler(90.0f, -90.0f, -180.0f));
        ...
        for (int i = 0; i < 8; ++i)
        {
            ...
            for (int j = 0; j < b; ++j)
            {
                int a = Random.Range(0, 4);
                if (a == 0)
                    obj = (GameObject)Instantiate(redCube, new Vector3(lastX, y + j * 2.4f, j == 0 ? blastZ -= size : blastZ), transform.rotation * Quaternion.Euler(90f, 0, 0));
                else if (a == 1)
                    obj = (GameObject)Instantiate(blueCube, new Vector3(lastX, y + j * 2.4f, j == 0 ? blastZ -= size : blastZ), transform.rotation * Quaternion.Euler(90f, 0, 0));
                else if (a == 2)
                    obj = (GameObject)Instantiate(yellowCube, new Vector3(lastX, y + j * 2.4f, j == 0 ? blastZ -= size : blastZ), transform.rotation * Quaternion.Euler(90f, 0, 0));
                else
                    obj = (GameObject)Instantiate(greenCube, new Vector3(lastX, y + j * 2.4f, j == 0 ? blastZ -= size : blastZ), transform.rotation * Quaternion.Euler(90f, 0, 0));
                obj.transform.parent = gameObject.transform;
            }
        }
        blastZ -= 2.5f;
        ...
        for (int i = 0; i < 17; ++i)
        {
            GameObject obj = (GameObject)Instantiate(redCube, new Vector3(lastX, y, lastZ += size), transform.rotation * Quaternion.Euler(90f, 0, 0));
            obj.transform.parent = gameObject.transform;
        }
        blastZ += 2.5f;
        //by
        for (int i = 0; i < 15; ++i)
        {
            GameObject obj = (GameObject)Instantiate(redCube, new Vector3(blastX, y, blastZ -= size), transform.rotation * Quaternion.Euler(90f, 0, 0));
            obj.transform.parent = gameObject.transform;
        }
        blastZ -= 2.5f;
        //bx
        for (int i = 0; i < 4; ++i)
        {
            GameObject obj = (GameObject)Instantiate(redCube, new Vector3(blastX += size, y, blastZ), transform.rotation);
            obj.transform.parent = gameObject.transform;
        }
        blastZ += 2.5f;
        //by
        ...
        for (int i = 0; i < 27; ++i)
        {
            GameObject obj = (GameObject)Instantiate(redCube, new Vector3(lastX += size, y, lastZ), transform.rotation);
            obj.transform.parent = gameObject.transform;
        }
        //bx
        for (int i = 0; i < 27; ++i)
